...
from imitation.algos.utils.diffuser_actor_utils.encoder import Encoder
from imitation.algos.utils.diffuser_actor_utils.layers import (
    FFWRelativeCrossAttentionModule,
    FFWRelativeSelfAttentionModule,
    FFWRelativeSelfCrossAttentionModule,
    ParallelAttention,
)
from imitation.algos.utils.diffuser_actor_utils.position_encodings import (
    RotaryPositionEncoding3D,
    SinusoidalPosEmb,
)
from imitation.algos.utils.diffuser_actor_utils.utils import (
...
from imitation.utils.point_cloud_utils import show_point_cloud
...
class DiffuserActor(ChunkPolicy):
    def __init__(
        ...
        **kwargs
        ...
        elif task_suite_name == "real":
            boundaries = ru.get_boundaries(benchmark_name=task_benchmark_name)
    ...
    def conditional_sample(self, condition_data, condition_mask, fixed_inputs):
        ...
        # Iterative denoising
        # self.position_noise_scheduler.set_timesteps(self.inference_timesteps)
        # self.rotation_noise_scheduler.set_timesteps(self.inference_timesteps)
    ...
    def compute_trajectory(
        ...
        if self._rotation_parametrization != "rotation_6d":
