...
def copy_data_pace(cfg, pace_tmp_dir):
    ...
    if suite_name == 'libero':
        ...
        # source_data_dir = os.path.join(source_data_prefix, suite_name, 'core_depth', benchmark_name)
        # target_data_dir = os.path.join(pace_tmp_dir, 'data', suite_name, 'core_depth', benchmark_name)
