...
def get_task_dataset(
    ...
    if load_obs:
        ...
        obs_keys = []
        # TODO: this is pretty hacky. separate out the lowdim keys and use those NVM
        # obs_keys = [key for key in shape_meta['all_obs_keys'] if np.prod(shape_meta['all_obs_keys'][key]) < 100]
