...
for task_name in ${task_names[@]}; do
    for seed in ${seeds[@]}; do
        ...
        #     exp_name=${exp_name} \
        #     task.task_name=${task_name} \
        #     variant_name=adapt3r_beefy_ft_hd_120 \
        #     algo=diffusion_policy \
        #     algo/encoder=beefy  \
        #     algo.encoder.finetune=true \
        ...
        #     exp_name=${exp_name} \
        #     task.task_name=${task_name} \
        #     variant_name=adapt3r_beefy_ft_np_1024 \
        #     algo=diffusion_policy \
        #     algo/encoder=beefy  \
        #     algo.encoder.finetune=true \
        ...
        #     exp_name=${exp_name} \
        #     task.task_name=${task_name} \
        #     variant_name=adapt3r_beefy_ft_np_1024_hd_120 \
        #     algo=diffusion_policy \
        #     algo/encoder=beefy  \
        #     algo.encoder.finetune=true \
        #     algo.encoder.num_points=1024 \
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_np_1024_hd_120 \
            algo=diffusion_policy \
            algo/encoder=beefy  \
            algo.encoder.num_points=1024 \
            algo.encoder.hidden_dim=120 \
