...
OUTPUT_DIR="${BASE_DIR}/data/mimicgen/core_depth_abs_rand"
...
file_names=(
    ...
    # "threading_d1.hdf5"
    "stack_d1.hdf5"
    "three_piece_assembly_d2.hdf5"
)

# Process each HDF5 file
for file_name in ${file_names[@]}; do
    echo "Submitting job for $file_name..."
    sbatch slurm/run_rtx6000.sbatch uv run ${SCRIPT_PATH} \
        --hdf5_path ${DATA_DIR}/${file_name} \
