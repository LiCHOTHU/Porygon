...
for task_name in ${task_names[@]}; do
    for seed in ${seeds[@]}; do
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_no_ds_no_attn \
            algo=diffusion_policy \
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_no_ds \
            algo=diffusion_policy \
            algo/encoder=beefy_2  \
            algo.chunk_size=8 \
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_no_ds_ft \
            algo=diffusion_policy \
            algo/encoder=beefy_2  \
            algo.chunk_size=8 \
            algo.encoder.pointcloud_extractor_factory.reduction=attention \
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_np_1024 \
            algo=diffusion_policy \
            algo/encoder=beefy  \
            algo.chunk_size=8 \
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_no_eecf \
            algo=diffusion_policy \
            algo/encoder=beefy  \
            algo.chunk_size=8 \
        ...
        sbatch slurm/run_l40s.sbatch python train.py \
            ...
            exp_name=${exp_name} \
            task.task_name=${task_name} \
            variant_name=adapt3r_beefy_hd_120 \
            algo=diffusion_policy \
            algo/encoder=beefy  \
            algo.chunk_size=8 \
            algo.encoder.hidden_dim=120 \
            training.save_interval=10 \
            train_dataloader.num_workers=4 \
            rollout.interval=1000 \
            task.demos_per_env=1000\
