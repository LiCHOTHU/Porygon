    ...
    for seed in ${seeds[@]}; do
        for downsample_mode in ${downsample_modes[@]}; do
            ...
            sbatch slurm/run_v100.sbatch python train.py \
                ...
                task=metaworld_mt50_hybrid \
                exp_name=${exp_name} \
                variant_name=flagship_no_image_block_${block} \
                algo=${algo} \
                algo/encoder=hybrid  \
                algo.chunk_size=${block} \
                algo.policy.temporal_agg=true \
            ...
            #     task=metaworld_mt50_hybrid \
            #     exp_name=${exp_name} \
            #     variant_name=flagship_no_lang_block_${block} \
            #     algo=${algo} \
            #     algo/encoder=hybrid  \
            #     algo.chunk_size=${block} \
            #     algo.policy.temporal_agg=true \
            ...
            #     task=metaworld_mt50_hybrid \
            #     exp_name=${exp_name} \
            #     variant_name=flagship_no_eecf_block_${block} \
            #     algo=${algo} \
            #     algo/encoder=hybrid  \
            #     algo.chunk_size=${block} \
            #     algo.policy.temporal_agg=true \
            ...
            #     task=metaworld_mt50_hybrid \
            #     exp_name=${exp_name} \
            #     variant_name=flagship_learned_lift_block_${block} \
            #     algo=${algo} \
            #     algo/encoder=hybrid  \
            #     algo.chunk_size=${block} \
            #     algo.policy.temporal_agg=true \
            ...
            #     task=metaworld_mt50_hybrid \
            #     exp_name=${exp_name} \
            #     variant_name=flagship_pos_downsample_block_${block} \
            #     algo=${algo} \
            #     algo/encoder=hybrid  \
            #     algo.chunk_size=${block} \
            #     algo.policy.temporal_agg=true \
            ...
            #     task=metaworld_mt50_hybrid \
            #     exp_name=${exp_name} \
            #     variant_name=flagship_no_attn_block_${block} \
            #     algo=${algo} \
            #     algo/encoder=hybrid  \
            #     algo.chunk_size=${block} \
            #     algo.policy.temporal_agg=true \
