...
# # With pos emb encoder

# sbatch slurm/run_l40s.sbatch python train.py \
#     --config-name=train_prior.yaml \
#     task=${task} \
#     exp_name=${exp_name} \
#     variant_name=dit_head_2_no_act_eecf_no_abs_pee \
#     pace_copy=true \
#     algo=dit_head_2 \
#     algo.chunk_size=15 \
#     algo.policy.hidden_dim=256 \
...
#     task=${task} \
#     exp_name=${exp_name} \
#     variant_name=dit_head_2_no_eecf_no_abs_pee \
#     pace_copy=true \
#     algo=dit_head_2 \
#     algo.chunk_size=15 \
#     algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_pee_interleave_fix \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_no_act_eecf_no_abs_pee_interleave_fix \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_no_eecf_no_abs_pee_interleave_fix \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_no_eecf_pee_interleave_fix \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_pee_interleave_npe \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_no_act_eecf_no_abs_pee_interleave_npe \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
...
sbatch slurm/run_l40s.sbatch python train.py \
    ...
    task=${task} \
    exp_name=${exp_name} \
    variant_name=dit_head_2_no_abs_no_3d \
    pace_copy=true \
    algo=dit_head_2 \
    algo.chunk_size=15 \
    algo.policy.hidden_dim=256 \
    algo.policy.num_layers=4 \
    +algo.policy.do_3d=false \
    algo.act_eecf=false \
    algo.abs_action=false \
    training.save_interval=10 \
    train_dataloader.num_workers=4 \
...
# #     algo.policy.num_layers=4 \
# #     algo.policy.add_pos_emb_encoder=true \
# #     +algo.policy.interleave_pos_only_attn=false \
# #     algo.obs_eecf=false \
# #     algo.act_eecf=false \
# #     algo.abs_action=true \
# #     training.save_interval=10 \
