...
prefix="/storage/home/hcoda1/1/awilcox31/vast/quest_v0/experiments/libero/libero_90/diffuser_actor/rss_rebuttal"
...
for variant_name in ${variant_names[@]}; do
    for seed in ${seeds[@]}; do
        sbatch slurm/run_l40s.sbatch python evaluate.py \
            ...
            checkpoint_path=${prefix}/${variant_name}/${seed}/stage_1/ \
