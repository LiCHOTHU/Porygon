...
improves a policy \citep{dipo2024,psenka2024qsm}, and --- not by
coincidence --- also how a drifting model is pretrained
\citep{deng2026drifting}, so on such a base fine-tuning is one more field
added to a transport the policy class already performs. What that family
does not do, and what this section contributes, is constrain the
displacement: in DIPO the improved action is wherever the gradient step
lands, and the policy is then regressed onto it.
