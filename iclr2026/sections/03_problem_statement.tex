...
\begin{figure}[t]
  ...
  earns is the whole failure. \textbf{(d)} The same mechanism measured in the
  real system: distance from the frozen base during LIBERO the red-mug task training. Without
  a base-restoring term the policy walks away without bound and success reaches
  $0.000$; with it the policy sits at the trust radius for the entire run.
