...
produced it). Removing either guard reproduces the family's failure inside
our own system: performance falls \emph{below} the untuned base
(\cref{tab:libero-ablation}). Test-time guidance \citep{qgf2026} applies the
same $\nabla_a Q$ signal without training at all, and is complementary.
