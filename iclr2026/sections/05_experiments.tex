...
are $8, 21, 32, 53, 65, 73, 75, 81$ in table order, and ``bp'' is the
backprop actor. Across the five tasks
...
task & base & bp & \method{}$_{1}$ & \method{}$_{2}$ & base & DICE & GRPO & \method{} \\
\midrule
...
starts higher. Read down the $\Delta$ column --- \emph{no} fine-tuner,
ours included, moves its base by more than seed noise.}
\label{tab:libero}
\small
\begin{tabular}{lcccc}
\toprule
