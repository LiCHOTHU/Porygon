...
over the four matched-protocol cells alone it is $0.771$. Within each base
block, bold marks the best entry on that row --- the two blocks use different
bases, so bolding is never applied across them. Across the five tasks
...
Living-2: orange juice into basket & 0.785 & 0.800 & 0.842 & \textbf{0.853} & \textbf{0.917} & 0.915 & 0.897 & 0.897 \\
...
Study-1: book into right caddy slot & 0.578 & 0.583 & \textbf{0.657} & 0.648 & \textbf{0.620} & 0.592 & 0.603 & 0.608 \\
Study-3: book into front caddy slot & 0.588 & \textbf{0.653} & 0.607 & 0.635 & \textbf{0.733} & 0.708 & 0.550$^{\ddagger}$ & 0.670 \\
\midrule
