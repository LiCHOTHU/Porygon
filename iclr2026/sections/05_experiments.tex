...
\textbf{Verdict.} Both halves hold: \method{} leads on the retrained
diffusion base ($0.955$ against $0.941$ at a matched budget), matches the
strongest published pipeline from the drifting base, and every
unconstrained-critic method sits at or below its base.
...
$0.382$), and the diffusion-base \method{} passes it ($0.955$ at the matched
budget, still improving).
