...
across blocks only same-block comparisons are meaningful. ``bp'' is the
backprop actor, and $\method{}_{\eta 1}$/$\method{}_{\eta 2}$ are
\method{} at reward-step $\eta_Q{=}1$ and $\eta_Q{=}2$, the only
hyperparameter that differs between them. Across the five tasks
...
task & base & bp & \method{}$_{\eta 1}$ & \method{}$_{\eta 2}$ & base & DICE & GRPO & \method{} \\
\midrule
