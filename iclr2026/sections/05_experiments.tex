...
$^{\dagger\dagger}$mean of seeds $42/43$ at $288$K steps ($0.93/0.92$), still
improving; seed $44$ and the paired \method{} seeds are at earlier steps and
the pair will be re-quoted at a matched budget when all six converge.
``---'' = not measured.}
\label{tab:baselines}
\footnotesize
...
\midrule
DIPO \citep{dipo2024}     & diffusion & 0.600 & training & --- \\
QSM \citep{psenka2024qsm} & diffusion & 0.600 & 0.000 & $-0.600$ \\
DQL                       & diffusion & 0.600 & 0.000 & $-0.600$ \\
IDQL                      & diffusion & 0.600 & training & --- \\
AWR                       & generic   & 0.600 & training & --- \\
DPPO \citep{ren2024dppo} & diffusion & 0.600 & training & --- \\
\midrule
...
diffusion $+$ DICE-RL $+$ \method{}$^{\P\P}$        & diffusion & 0.600 & training & --- \\
\addlinespace
