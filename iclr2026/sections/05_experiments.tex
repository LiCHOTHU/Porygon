...
$^{\dagger\dagger}$both paired arms saturate at the same ${\approx}0.96$
ceiling (quoted at a matched $496$K steps, three seeds each; seed ranges
overlap fully there). The separation is \emph{speed}: \method{} first
reaches $0.90$ success at $128/160/160$K steps against DICE-RL's
$224/240/256$K --- \method{}'s slowest seed beats DICE-RL's fastest with no
overlap, $1.6\times$ less interaction on average. Where the ceiling is the
environment's, sample efficiency is the comparison that remains.
