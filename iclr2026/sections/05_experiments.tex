...
\addlinespace
flow matching $+$ DICE-RL \citep{dicerl2026} & flow matching & --- & 0.831$^{\P}$ & --- \\
flow matching $+$ DICE-RL $+$ \method{}      & flow matching & --- & \textbf{0.934}$^{\P}$ & --- \\
\bottomrule
\end{tabular}}
\end{table}
...
Kitchen-3: turn on stove, put pan on  & 0.690 & 0.703 & 0.737 & \textbf{0.752} & 0.700 & 0.730 & --- & 0.690 \\
