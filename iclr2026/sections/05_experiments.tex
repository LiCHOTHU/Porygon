...
rather than blank, and withhold the GRPO row mean until all eight are on the
same protocol. Across the five tasks
...
\midrule
Kitchen-1: open drawer, put bowl in & 0.818 & 0.820 & 0.831 & 0.857 & 0.897 & 0.873 & 0.800$^{\ddagger}$ & \textbf{0.900} \\
Kitchen-3: turn on stove, put pan on & 0.690 & 0.703 & 0.737 & \textbf{0.752} & 0.700 & 0.730 & 0.700$^{\ddagger}$ & 0.690 \\
...
Study-1: book into front caddy slot & 0.648 & 0.663 & 0.710 & \textbf{0.752} & 0.683 & 0.690 & 0.600$^{\ddagger}$ & 0.667 \\
Study-1: book into right caddy slot   & 0.578 & 0.583 & \textbf{0.657} & 0.648 & 0.620 & 0.592 & 0.603 & 0.608 \\
Study-3: book into front caddy slot & 0.588 & 0.653 & 0.607 & 0.635 & \textbf{0.733} & 0.708 & 0.550$^{\ddagger}$ & 0.670 \\
\midrule
mean over the eight tasks             & 0.661 & 0.670 & 0.738 & \textbf{0.755} & 0.753 & 0.750 & --- & \textbf{0.756} \\
\bottomrule
\end{tabular}}
\end{table}
