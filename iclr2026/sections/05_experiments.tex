...
current budgets: DICE-RL from seeds $42/43$ at $288$K ($0.93/0.92$), \method{}
from all three seeds at $128$K ($0.83/0.89/0.82$). At the matched $128$K point
\method{} reads $0.85$ against DICE-RL's $0.82$; the pair will be re-quoted at
a single matched budget when all six seeds converge.
...
\midrule
DIPO \citep{dipo2024}     & diffusion & 0.600$^{*}$ & 0.289$^{\circ}$ & $-0.059$ \\
QSM \citep{psenka2024qsm} & diffusion & 0.600$^{*}$ & 0.000 & $-0.348$ \\
DQL                       & diffusion & 0.600$^{*}$ & 0.000 & $-0.348$ \\
IDQL                      & diffusion & 0.600$^{*}$ & 0.274$^{\circ}$ & $-0.083$ \\
AWR                       & generic   & 0.600$^{*}$ & 0.311$^{\circ}$ & $+0.015$ \\
...
diffusion $+$ DICE-RL \citep{dicerl2026}$^{\P\P}$   & diffusion & 0.600 & 0.92$^{\dagger\dagger}$ & $+0.32$ \\
diffusion $+$ DICE-RL $+$ \method{}$^{\P\P}$        & diffusion & 0.600 & 0.85$^{\dagger\dagger}$ & $+0.25$ \\
\addlinespace
