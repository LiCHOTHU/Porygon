...
small corrections have different effects. A hinge can express the same radial
geometry in a conventional actor loss, but clipping and finite optimization
can yield different behavior. Our paired ablations therefore test both the
geometry and its implementation across tasks. We do not assume that target
regression alone resolves critic error.
